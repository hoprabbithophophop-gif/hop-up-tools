 ...
 * debugDetailPage, debugRawHtml, UFtestEvents → archive/upfc-scraper-debug.js
 *   （2026-09-04。デバッグ・検証が済んだため本番から外した）
 * UFbackfillOpenAt, UFbackfillOpenAtPreview, UF_BACKFILL_TARGETS → archive/upfc-backfill-open-at.js
 *   （2026-09-04。対象24件の開場時刻を埋め終えたため本番から外した）
 */
