...
export default function ReportForm({ video, onClose }: { video: VideoLink; onClose: () => void }) {
          ...
          <>
            ...
            {issue === "other" && (
              <textarea
                ...
                rows={3}
                maxLength={300}
                style={{ background: "#1a1a1a", color: "#fff", border: "none", padding: "0.6rem", fontSize: "0.8rem", resize: "vertical", fontFamily: "inherit" }}
              />
            )}
            <button
              onClick={submit}
