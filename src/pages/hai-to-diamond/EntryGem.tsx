...
// 転がりは焼いてある24コマを1コマずつ順に出す。速さは本編の飛ぶ💎と同じ（自分の分は1周＝24コマを飛ぶ時間1.26秒で回りきる）。
// 9秒で1周にすると紙芝居に見え、隣の2枚を溶かして繋ぐと明滅した（Hop指摘 2026-09-14）
...
const ENTRY_TURN_MS = 1260;      // 1周（24コマ）にかける時間(ms)。本編の自分の💎の飛ぶ時間（flight.ts の SELF_SUCK_MS）と同じ
