...
/** ツールの副題。入口の見出しの下・タブ・OGPに出す名前の一部で、投稿用のタグではない。
 *  「届くよ」を「届けよ」に変えたひねり入り（Hop決定 2026-09-07）。放つ演出の「届けよ」と対になっている */
export const SUBTITLE_TAG = "#銀河to銀河届けよ";
/** シェア文面（Hop確定 2026-09-06・A案）。タグとURLは指定のものだけ。URLは仮のルート名。
 *  タグは公式のリリース用タグ1つ（Hop決定 2026-09-19）。まわりが公式タグに揃える流れになったため。
 *  以前は独自の #銀河to銀河届けよ を広がりの確認用に付けていたが、広がりは記録の端末数などで見られるので外した */
export const SHARE_TAG = "#輝きなビヨちゃん";
